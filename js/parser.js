...
=======
parser = (function() {
>>>>>>> a8263998ff15bb0efd75cd3c0a73944bc304b998
  /*
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c69 = function(contents) {return  contents;},
        peg$c70 = function(left, right) {return left + "@" + right;},
        peg$c71 = function(left, right) {return left + "^" + right;},
        peg$c72 = "for",
        peg$c73 = { type: "literal", value: "for", description: "\"for\"" },
        peg$c74 = "(",
        peg$c75 = { type: "literal", value: "(", description: "\"(\"" },
        peg$c76 = ")",
        peg$c77 = { type: "literal", value: ")", description: "\")\"" },
        peg$c78 = function(left, right, comparison, substitution, block) {
                var a = block[0];
                if(block.length == 0){
                  a = "";
                }
        ...
        peg$c79 = "double",
        peg$c80 = { type: "literal", value: "double", description: "\"double\"" },
        peg$c81 = function(va, left, right, comparison, substitution, block) {
                var a = block[0];
                if(block.length == 0){
                  a = "";
                }
        ...
        peg$c82 = "while",
        peg$c83 = { type: "literal", value: "while", description: "\"while\"" },
        peg$c84 = function(comparison, block) {
                var a = block[0];
                if(block.length == 0){
                  a = "";
                }
        ...
        peg$c85 = "break",
        peg$c86 = { type: "literal", value: "break", description: "\"break\"" },
        peg$c87 = function() {return "break_js();" ;},
        peg$c88 = function(result) { return result + 'end_of_if();' ;  },
        peg$c89 = "else",
        peg$c90 = { type: "literal", value: "else", description: "\"else\"" },
        peg$c91 = function(left, block) {
             var a = block[0];
                if(block.length == 0){
                  a = "";
                }
        ...
        peg$c96 = function(left, comparison, block, right) {
                var a = block[0];
                if(block.length == 0){
                  a = "";
                }
        ...
        peg$c97 = function(left, comparison, block) {
                var a = block[0];
                if(block.length == 0){
                  a = "";
                }
        ...
        peg$c100 = function(left, right) { return 'push_line(' + peg$computePosDetails(peg$reportedPos).line +');substitute("' + left + '","' + right + '");' ; },
        peg$c101 = "++",
        peg$c102 = { type: "literal", value: "++", description: "\"++\"" },
        peg$c103 = function(left) { return 'push_line(' + peg$computePosDetails(peg$reportedPos).line +');substitute("' + left + '","' + left + ':+:1'+ '");' ; },
        peg$c104 = "--",
        peg$c105 = { type: "literal", value: "--", description: "\"--\"" },
        peg$c106 = function(left) { return 'push_line(' + peg$computePosDetails(peg$reportedPos).line +');substitute("' + left + '","' + left + ':-:1' + '");' ; },
        peg$c107 = "+=",
        peg$c108 = { type: "literal", value: "+=", description: "\"+=\"" },
        peg$c109 = function(left, right) { return 'push_line(' + peg$computePosDetails(peg$reportedPos).line +');substitute("' + left + '","' + left + ':+:' + right + '");' ; },
        peg$c110 = "-=",
        peg$c111 = { type: "literal", value: "-=", description: "\"-=\"" },
        peg$c112 = function(left, right) { return 'push_line(' + peg$computePosDetails(peg$reportedPos).line +');substitute("' + left + '","' + left + ':-:' + right + '");' ; },
        peg$c113 = "'",
        ...
        peg$c128 = function(comparison_same) { return "!" + comparison_same ;},
        peg$c129 = "==",
        ...
        peg$c140 = function(left, right) { return left + " >= " + right ; },
        peg$c141 = "<=",
        peg$c142 = { type: "literal", value: "<=", description: "\"<=\"" },
        peg$c143 = function(left, right) { return left + " <= " + right ; },
        peg$c144 = "!=",
        peg$c145 = { type: "literal", value: "!=", description: "\"!=\"" },
        peg$c146 = function(left, right) { return left + " != " + right ; },
        peg$c147 = "scanf",
        peg$c148 = { type: "literal", value: "scanf", description: "\"scanf\"" },
        peg$c149 = /^["]/,
        ...
        peg$c155 = function(type, variable) { return 'push_line(' + peg$computePosDetails(peg$reportedPos).line +');scanf_js("' + variable + '","' + type + '");' ;  },
        peg$c156 = function(contents, variable) {
        ...
        peg$c159 = function(left, type, right) { return "::" + type + "::" + right; },
        peg$c160 = function() { return ""; },
        peg$c161 = "%",
        peg$c162 = { type: "literal", value: "%", description: "\"%\"" },
        peg$c163 = "d",
        peg$c164 = { type: "literal", value: "d", description: "\"d\"" },
        peg$c165 = "o",
        peg$c166 = { type: "literal", value: "o", description: "\"o\"" },
        peg$c167 = "x",
        peg$c168 = { type: "literal", value: "x", description: "\"x\"" },
        peg$c169 = "X",
        peg$c170 = { type: "literal", value: "X", description: "\"X\"" },
        peg$c171 = "c",
        peg$c172 = { type: "literal", value: "c", description: "\"c\"" },
        peg$c173 = "s",
        peg$c174 = { type: "literal", value: "s", description: "\"s\"" },
        peg$c175 = "f",
        peg$c176 = { type: "literal", value: "f", description: "\"f\"" },
        peg$c177 = "lf",
        peg$c178 = { type: "literal", value: "lf", description: "\"lf\"" },
        peg$c179 = function(type) {return "%" + type;},
        peg$c180 = function(left, right) {return left + "," + right;},
        peg$c181 = function(add) {return add},
        peg$c182 = "printf",
        peg$c183 = { type: "literal", value: "printf", description: "\"printf\"" },
        peg$c184 = function(type, variable) {return 'push_line(' + peg$computePosDetails(peg$reportedPos).line +');printf_js("' + variable + '","' + type + '");' ;  },
        peg$c185 = function(contents, variable) {
        ...
        peg$c194 = "g",
        peg$c195 = { type: "literal", value: "g", description: "\"g\"" },
        peg$c196 = "G",
        peg$c197 = { type: "literal", value: "G", description: "\"G\"" },
        peg$c198 = /^[^"%,+]/,
        peg$c199 = { type: "class", value: "[^\"%,+]", description: "[^\"%,+]" },
        peg$c200 = function(letter) { return letter.join("").replace(/,/g,""); },
        peg$c201 = /^[^"]/,
        peg$c202 = { type: "class", value: "[^\"]", description: "[^\"]" },
        peg$c203 = "return",
        peg$c204 = { type: "literal", value: "return", description: "\"return\"" },
        peg$c205 = function(result) {return "push_line(" + peg$computePosDetails(peg$reportedPos).line +");return_js(" + result + ");" ;},
        peg$c206 = "+",
        peg$c207 = { type: "literal", value: "+", description: "\"+\"" },
        peg$c208 = function(left, right) { return left + ":" + "+" + ":" + right; },
        peg$c209 = "*",
        peg$c210 = { type: "literal", value: "*", description: "\"*\"" },
        peg$c211 = function(left, right) { return left + ":" + "*" + ":" + right; },
        peg$c212 = "-",
        ...
        peg$c219 = function(additive) { return "(" + ":" + additive + ":" + ")"; },
        peg$c220 = function(result) {return "-" + result},
        peg$c221 = ".",
        peg$c222 = { type: "literal", value: ".", description: "\".\"" },
        peg$c223 = function(left, right) { return parseFloat(left + "." + right) },
        peg$c224 = { type: "other", description: "integer" },
        peg$c225 = /^[0-9]/,
        peg$c226 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c227 = function(digits) { return parseInt(digits.join(""), 10); },
        peg$c228 = function(digits) { return digits.join("").replace(/,/g,""); },
        peg$c229 = /^[a-zA-Z0-9]/,
        peg$c230 = { type: "class", value: "[a-zA-Z0-9]", description: "[a-zA-Z0-9]" },
        peg$c231 = function(char) { return variable.join("").replace(/,/g,""); },
        peg$c232 = function(variable) { return variable.join("").replace(/,/g,""); },
        peg$c233 = function(variable, num1, num2) { return variable + "[" + num1 + "][" + num2 + "]"  },
        peg$c234 = function(variable, num) { return variable + "[" + num + "]" },
        peg$c235 = /^[ \n\t]/,
        ...
        peg$c241 = function() {return  "push_line(" + peg$computePosDetails(peg$reportedPos).line +");"},
                                                ...
                                                if (s21 !== peg$FAILED) {
                                                  ...
                                                  if (s22 !== peg$FAILED) {
                                                    ...
                                                    if (s23 !== peg$FAILED) {
                                                      ...
                                                      if (s24 !== peg$FAILED) {
                                                        peg$reportedPos = s0;
                                                        s1 = peg$c81(s5, s7, s11, s15, s19, s23);
                                                        s0 = s1;
                                                      } else {
                                                        peg$currPos = s0;
                                                        s0 = peg$c0;
